...
public class NewsApiBean extends ShowApiBean<NewsApiBean.ShowapiResBodyBean> {
    ...
    public static class ShowapiResBodyBean extends ShowApiBody{
        ...
        public ShowapiResBodyBean setPagebean(PagebeanBean pagebean) {
        ...
        public static class PagebeanBean {
            ...
            @Override
            public String toString() {
                final StringBuilder sb = new StringBuilder("PagebeanBean{");
            ...
            public static class ContentlistBean {
                ...
                @Override
                public String toString() {
                    final StringBuilder sb = new StringBuilder("ContentlistBean{");
